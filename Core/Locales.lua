...
L["OPT_MINIMAP_DETACH_TITLE"]  = "Detach from minimap"
L["OPT_MINIMAP_DETACH_DESC"]   = "Shift-drag then places the icon anywhere on screen instead of along the map edge. Picking a position above re-attaches it."
...
L["OPT_MINIMAP_ACCENT_DESC"]   = "Colours the glow — and any icon style that supports tinting — with the accent colour, following EllesmereUI's accent when its skin is active."
...
L["MEMORY_NEW_SINCE"]          = "New mail is waiting."
...
if GetLocale() == "frFR" then
  ...
  L["MEMORY_NEW_SINCE"]          = "Du nouveau courrier attend."
  ...
  L["OPT_MINIMAP_DETACH_TITLE"]  = "Detacher de la minicarte"
  L["OPT_MINIMAP_DETACH_DESC"]   = "Maj-glisser place alors l'icone n'importe ou a l'ecran au lieu du bord de la carte. Choisir une position ci-dessus la rattache."
  ...
  L["OPT_MINIMAP_ACCENT_TITLE"]  = "Accent"
  L["OPT_MINIMAP_ACCENT_DESC"]   = "Colore le halo — et tout style d'icone qui accepte la teinte — avec la couleur d'accent, en suivant celle d'EllesmereUI quand son habillage est actif."
...
if GetLocale() == "deDE" then
  ...
  L["MEMORY_NEW_SINCE"]          = "Neue Post wartet."
  ...
  L["OPT_MINIMAP_DETACH_TITLE"]  = "Von der Minikarte loesen"
  L["OPT_MINIMAP_DETACH_DESC"]   = "Umschalt-Ziehen platziert das Symbol dann frei auf dem Bildschirm statt am Kartenrand. Eine Position oben heftet es wieder an."
  ...
  L["OPT_MINIMAP_ACCENT_DESC"]   = "Faerbt das Leuchten — und jeden Symbolstil, der Einfaerben unterstuetzt — in der Akzentfarbe, bei aktivem EllesmereUI-Skin in dessen Akzent."
...
if esLocale == "esES" or esLocale == "esMX" then
  ...
  L["MEMORY_NEW_SINCE"]          = "Hay correo nuevo esperando."
  ...
  L["OPT_MINIMAP_DETACH_TITLE"]  = "Separar del minimapa"
  L["OPT_MINIMAP_DETACH_DESC"]   = "Mayus y arrastrar coloca el icono en cualquier parte de la pantalla en vez del borde del mapa. Elegir una posicion arriba lo vuelve a fijar."
  ...
  L["OPT_MINIMAP_ACCENT_DESC"]   = "Colorea el brillo — y cualquier estilo de icono que admita tinte — con el color de acento, siguiendo el de EllesmereUI cuando su apariencia esta activa."
...
L["MEMORY_NEW_SINCE"]          = "Ожидает новая почта."
...
L["OPT_MINIMAP_DETACH_TITLE"]  = "Открепить от миникарты"
L["OPT_MINIMAP_DETACH_DESC"]   = "Shift + перетаскивание размещает значок в любом месте экрана, а не только по краю карты. Выбор позиции выше снова прикрепляет его."
...
L["OPT_MINIMAP_ACCENT_DESC"]   = "Окрашивает свечение — и те стили значка, что поддерживают окраску, — в акцентный цвет; при активном оформлении EllesmereUI используется его акцент."
