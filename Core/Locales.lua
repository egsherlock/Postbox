...
L["QUEUE_TIP_HOW"]             = "With every slot full, right-clicked items wait here. They go out after this mail, twelve at a time, to the same recipient with the same subject and message."
L["QUEUE_TIP_CLEAR"]           = "Right-click to forget them. They stay in your bags."
...
if GetLocale() == "frFR" then
  ...
  L["QUEUE_TIP_HOW"]             = "Quand tous les emplacements sont pleins, les objets sur lesquels tu fais un clic droit attendent ici. Ils partent apres ce courrier, douze a la fois, au meme destinataire avec le meme sujet et le meme message."
  L["QUEUE_TIP_CLEAR"]           = "Clic droit pour les oublier. Ils restent dans tes sacs."
...
if GetLocale() == "deDE" then
  ...
  L["QUEUE_TIP_HOW"]             = "Sind alle Plaetze belegt, warten per Rechtsklick gewaehlte Gegenstaende hier. Sie gehen nach dieser Post raus, zwoelf auf einmal, an denselben Empfaenger mit demselben Betreff und derselben Nachricht."
  L["QUEUE_TIP_CLEAR"]           = "Rechtsklick, um sie zu vergessen. Sie bleiben in deinen Taschen."
...
if esLocale == "esES" or esLocale == "esMX" then
  ...
  L["QUEUE_TIP_HOW"]             = "Con todos los huecos llenos, los objetos en los que hagas clic derecho esperan aqui. Salen despues de este correo, de doce en doce, al mismo destinatario con el mismo asunto y mensaje."
  L["QUEUE_TIP_CLEAR"]           = "Clic derecho para olvidarlos. Siguen en tus bolsas."
...
L["QUEUE_TIP_HOW"]             = "Когда все ячейки заняты, предметы по правому клику ждут здесь. Они уйдут после этого письма, по двенадцать за раз, тому же получателю с той же темой и текстом."
L["QUEUE_TIP_CLEAR"]           = "Правый клик, чтобы забыть их. Они останутся в сумках."
