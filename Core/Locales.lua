...
L["OPT_MINIMAP_EUI_NOTE"]      = "EllesmereUI's minimap shows a mail icon of its own that Postbox does not touch, so you may see both."
...
if GetLocale() == "frFR" then
  ...
  L["OPT_MINIMAP_EUI_NOTE"]      = "La minicarte d'EllesmereUI affiche sa propre icone de courrier, que Postbox ne touche pas ; tu peux donc voir les deux."
...
if GetLocale() == "deDE" then
  ...
  L["OPT_MINIMAP_EUI_NOTE"]      = "Die Minikarte von EllesmereUI zeigt ein eigenes Postsymbol, das Postbox nicht anruehrt; du siehst also womoeglich beide."
...
if esLocale == "esES" or esLocale == "esMX" then
  ...
  L["OPT_MINIMAP_EUI_NOTE"]      = "El minimapa de EllesmereUI muestra su propio icono de correo, que Postbox no toca; puede que veas ambos."
...
L["OPT_MINIMAP_EUI_NOTE"]      = "Миникарта EllesmereUI показывает собственный значок почты, который Postbox не трогает, — возможно, вы увидите оба."
