...
L["OPT_QUICK_ATTACH_TITLE"]    = "Attach from the Mail tab"
L["OPT_QUICK_ATTACH_DESC"]     = "Right-click a bag item while reading mail and the window flips to Send with it attached; off, bag items keep their usual right-click until the Send tab is open."
...
L["OPT_MINIMAP_POS_DETACHED"]  = "Detached (shift-drag anywhere)"
...
L["MEMORY_NEW_SINCE"]          = "New mail has arrived since."
...
if GetLocale() == "frFR" then
  ...
  L["MEMORY_NEW_SINCE"]          = "Du nouveau courrier est arrive depuis."
  ...
  L["OPT_QUICK_ATTACH_TITLE"]    = "Joindre depuis Courrier"
  L["OPT_QUICK_ATTACH_DESC"]     = "Un clic droit sur un objet des sacs pendant la lecture du courrier bascule sur Envoyer avec l'objet joint ; desactive, les sacs gardent leur clic droit habituel tant que l'onglet Envoyer n'est pas ouvert."
  ...
  L["OPT_MINIMAP_POS_DETACHED"]  = "Detachee (Maj-glisser libre)"
  L["OPT_MINIMAP_ACCENT_TITLE"]  = "Accent"
...
if GetLocale() == "deDE" then
  ...
  L["MEMORY_NEW_SINCE"]          = "Seitdem ist neue Post eingetroffen."
  ...
  L["OPT_QUICK_ATTACH_TITLE"]    = "Anhaengen vom Post-Tab"
  L["OPT_QUICK_ATTACH_DESC"]     = "Ein Rechtsklick auf einen Taschengegenstand beim Lesen der Post wechselt zu Senden und haengt ihn an; ausgeschaltet behalten die Taschen ihren ueblichen Rechtsklick, bis der Senden-Tab offen ist."
  ...
  L["OPT_MINIMAP_POS_DETACHED"]  = "Abgeloest (Umschalt-Ziehen frei)"
...
if esLocale == "esES" or esLocale == "esMX" then
  ...
  L["MEMORY_NEW_SINCE"]          = "Ha llegado correo nuevo desde entonces."
  ...
  L["OPT_QUICK_ATTACH_TITLE"]    = "Adjuntar desde Correo"
  L["OPT_QUICK_ATTACH_DESC"]     = "Un clic derecho en un objeto de las bolsas mientras lees el correo pasa a Enviar con el objeto adjunto; desactivado, las bolsas conservan su clic derecho habitual hasta abrir Enviar."
  ...
  L["OPT_MINIMAP_POS_DETACHED"]  = "Suelta (Mayus y arrastrar libre)"
...
L["MEMORY_NEW_SINCE"]          = "С тех пор пришла новая почта."
...
L["OPT_QUICK_ATTACH_TITLE"]    = "Вложение со вкладки «Почта»"
L["OPT_QUICK_ATTACH_DESC"]     = "Правый клик по предмету в сумках при чтении почты переключает на «Отправка» и прикладывает предмет; выключено — правый клик в сумках работает как обычно, пока не открыта вкладка «Отправка»."
...
L["OPT_MINIMAP_POS_DETACHED"]  = "Откреплено (Shift + перетаскивание)"
