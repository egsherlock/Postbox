...
L["MINIMAP_TIP_HINT"]          = "Right-click for options. Shift-drag to move."
...
if GetLocale() == "frFR" then
  ...
  L["MINIMAP_TIP_HINT"]          = "Clic droit : options. Maj-glisser : deplacer."
...
if GetLocale() == "deDE" then
  ...
  L["MINIMAP_TIP_HINT"]          = "Rechtsklick: Optionen. Umschalt-Ziehen: verschieben."
...
if esLocale == "esES" or esLocale == "esMX" then
  ...
  L["MINIMAP_TIP_HINT"]          = "Clic derecho: opciones. Mayus y arrastrar: mover."
...
L["MINIMAP_TIP_HINT"]          = "Правый клик: настройки. Shift + перетаскивание: переместить."
