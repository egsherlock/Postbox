...
L["OPT_TAB_CAPTION_COUNTS"]    = "To collect / total"
L["OPT_TAB_CAPTION_TOTAL"]     = "Total only"
L["OPT_TAB_CAPTION_DOT"]       = "Dot when mail waits"
...
if GetLocale() == "frFR" then
  ...
  L["OPT_TAB_CAPTION_DOT"]       = "Point quand du courrier attend"
...
if GetLocale() == "deDE" then
  ...
  L["OPT_TAB_CAPTION_DOT"]       = "Punkt, wenn Post wartet"
...
if esLocale == "esES" or esLocale == "esMX" then
  ...
  L["OPT_TAB_CAPTION_DOT"]       = "Punto cuando hay correo"
...
L["OPT_TAB_CAPTION_DOT"]       = "Точка, когда есть почта"
